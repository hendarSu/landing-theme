...
export const metadata: Metadata = {
  title: "Sanggar Seni PEPADI | Persatuan Pedalangan Indonesia",
  description: "Temukan sanggar seni wayang dan pedalangan di seluruh Indonesia yang tergabung dalam PEPADI.",
}

export default function SanggarSeniPage() {
  const sanggarList = [
    {
      id: 1,
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-center mb-6">Sanggar Seni PEPADI</h1>
